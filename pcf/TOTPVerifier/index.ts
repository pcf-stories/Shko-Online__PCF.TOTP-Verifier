...
export class TOTPVerifier implements ComponentFramework.StandardControl<IInputs, IOutputs> {
  ...
  public init(
    ...
    this.div1.setAttribute(
      'class',
      'w-full h-full flex flex-col justify-center text-center items-center content-around',
    );
